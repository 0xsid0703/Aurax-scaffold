      ...
      <div className="container flex flex-col px-5 py-10 md:flex-row md:justify-between">
        ...
        <div className="grid grid-cols-2 gap-5 md:grid-cols-4">
          <div className="flex flex-col gap-3">
            ...
            <Link className="text-[16px] font-semibold text-gray-500 hover:text-white" href="/careers">
              Careers
            </Link>
            <Link className="text-[16px] font-semibold text-gray-500 hover:text-white" href="/media-kit">
              Media Kit
            </Link>
          </div>
          <div className="flex flex-col gap-3">
            <div className="text-[24px] font-bold">Research</div>
            <Link className="text-[16px] font-semibold text-gray-500 hover:text-white" href="/v2-stats">
              v2 Stats
            </Link>
            <Link className="text-[16px] font-semibold text-gray-500 hover:text-white" href="/validator-security">
              Validator Security
            </Link>
            <Link className="text-[16px] font-semibold text-gray-500 hover:text-white" href="/documentation">
              Documentation
            </Link>
          </div>
          <div className="flex flex-col gap-3">
            <div className="text-[24px] font-bold">Developers</div>
            <Link className="text-[16px] font-semibold text-gray-500 hover:text-white" href="/protocol-code">
              Protocol Code
            </Link>
            <Link className="text-[16px] font-semibold text-gray-500 hover:text-white" href="/technical-docs">
              Technical Docs
            </Link>
            <Link className="text-[16px] font-semibold text-gray-500 hover:text-white" href="/python-sdk">
              Python SDK
            </Link>
            <Link className="text-[16px] font-semibold text-gray-500 hover:text-white" href="/typescript-sdk">
              Typescript SDK
            </Link>
            <Link className="text-[16px] font-semibold text-gray-500 hover:text-white" href="/trail-of-bits-audit">
              Trail of Bits Audit
            </Link>
            <Link className="text-[16px] font-semibold text-gray-500 hover:text-white" href="/neodyme-audit">
              Neodyme Audit
            </Link>
